export default function NecklaceGrid({ catalogue, activeId, setActiveId }) {
  return (
      ...
      {catalogue.map(necklace => {
        ...
        return (
          <button
            ...
            className={`text-left bg-white rounded-lg overflow-hidden border transition-all duration-200 relative
              ${isActive
